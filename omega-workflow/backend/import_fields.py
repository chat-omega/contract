...
def import_fields():
    ...
    possible_paths = [
        ...
        '/app/design/fields.json',  # Container path
    ...
    try:
        ...
        print(f"📁 Total in database: {db.get_field_count()} fields")
...
def test_import():
    ...
    # Test search
    search_results = db.get_fields(search="Assignment", limit=3)
